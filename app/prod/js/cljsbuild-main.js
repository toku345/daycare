...
var daycare = {core:{}};
daycare.core.path = cljs.nodejs.require.call(null, "path");
daycare.core.Electron = cljs.nodejs.require.call(null, "electron");
daycare.core.BrowserWindow = daycare.core.Electron.BrowserWindow;
daycare.core.crash_reporter = daycare.core.Electron.crashReporter;
daycare.core.Os = cljs.nodejs.require.call(null, "os");
daycare.core._STAR_win_STAR_ = cljs.core.atom.call(null, null);
daycare.core.app = daycare.core.Electron.app;
daycare.core._main = function() {
  daycare.core.crash_reporter.start(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "companyName", "companyName", 2030952346), "toku345", new cljs.core.Keyword(null, "submitURL", "submitURL", -169159433), "http://github.com/toku345"], null)));
  cljs.nodejs.process.on("error", function(a) {
    return console.log(a);
  });
  daycare.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? daycare.core.app.quit() : null;
  });
  return daycare.core.app.on("ready", function() {
    cljs.core.reset_BANG_.call(null, daycare.core._STAR_win_STAR_, new daycare.core.BrowserWindow(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "width", "width", -384071477), 800, new cljs.core.Keyword(null, "height", "height", 1025178622), 600], null))));
    cljs.core.deref.call(null, daycare.core._STAR_win_STAR_).loadURL([cljs.core.str("file://"), cljs.core.str(daycare.core.path.resolve(__dirname, "../index.html"))].join(""));
    return cljs.core.deref.call(null, daycare.core._STAR_win_STAR_).on("closed", function() {
      return cljs.core.reset_BANG_.call(null, daycare.core._STAR_win_STAR_, null);
    });
  });
};
cljs.nodejs.enable_util_print_BANG_.call(null);
console.log([cljs.core.str("Start descjop application on "), cljs.core.str(daycare.core.Os.type()), cljs.core.str(".")].join(""));
cljs.core._STAR_main_cli_fn_STAR_ = daycare.core._main;
cljs.nodejscli = {};
